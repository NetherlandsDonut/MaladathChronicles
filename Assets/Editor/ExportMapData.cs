...
public class ExportMapData : EditorWindow
{
    [MenuItem("Window/My Utilities/Map Tools")]
    public static void MapTools()
    {
        ExportMapData mapTools = GetWindow<ExportMapData>("Map Tools", true);
        mapTools.Show();
    }
