...
public class Board
{
    ...
    public void EndTurn()
    {
        ...
        //Decrease the threat generated by the current participant by 10%
        participants[whosTurn].generatedThreat = (int)(participants[whosTurn].generatedThreat * 0.9);
        ...
        if (result != "Quit")
        {
            ...
            if (result == "Team1Won")
            {
                ...
                foreach (var defeatedEnemy in participants.Where(x => x.team == 2))
                {
                    ...
                    if (defeatedEnemy.who.specialLoot != null) directDrop.Add(defeatedEnemy.who.specialLoot);
