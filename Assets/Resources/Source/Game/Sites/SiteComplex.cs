...
public class SiteComplex : Site
{
    ...
    public override void PrintSite()
    {
        ...
        AddPaddingRegion(() =>
        {
            ...
            if (todos.Count > 0 || normals || (lows && settings.showLowLevelQuests.Value()) || returns) sitesWithQuestMarkers.Add(this);
            if (returns && normals) AddSmallButtonOverlay("AvailableQuestReturnNormal", 0, 3);
            else if (returns && lows && settings.showLowLevelQuests.Value()) AddSmallButtonOverlay("AvailableQuestReturnLow", 0, 3);
            ...
            else if (lows && settings.showLowLevelQuests.Value()) AddSmallButtonOverlay("AvailableQuestLow", 0, 3);
